...
var map = L.mapbox.map('map', 'aarondennis.f6516522', { // Create a new map using the map tiles 'aarondennis.f6516522' in the map div
    ...
    maxZoom: 19, // set how far into the map you can zoom to zoom level 19
    minZoom: 15  // set how far out from the map you can zoom to zoom level 15
...
// Add overlay data to the map
var overlay = L.mapbox.featureLayer().loadURL('./data/campus-map-overlay.json').addTo(map); // loads in the geojson file in the data folder

$.getJSON("./data/centroids.json", function(json) {
    console.log(json);
    var centroids = json;
